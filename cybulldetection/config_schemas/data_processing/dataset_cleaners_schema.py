...
class SpellCorrectionModelConfig:
    _target_: str = "cybulldetection.utils.utils.SpellCorrectionModel"
...
class StopWordsDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.StopWordsDatasetCleaner"


@dataclass
class LowerCaseDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.LowerCaseDatasetCleaner"


@dataclass
class URLDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.URLDatasetCleaner"


@dataclass
class PunctuationDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.PunctuationDatasetCleaner"
    punctuation: str = string.punctuation


@dataclass
class NonLettersDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.NonLettersDatasetCleaner"


@dataclass
class NewLineCharacterDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.NewLineCharacterDatasetCleaner"


@dataclass
class NonASCIIDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.NonASCIIDatasetCleaner"


@dataclass
class ReferanceToAccountDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.ReferanceToAccountDatasetCleaner"


@dataclass
class ReTweetDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.ReTweetDatasetCleaner"


@dataclass
class SpellCorrectionDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.SpellCorrectionDatasetCleaner"
    spell_correction_model: SpellCorrectionModelConfig = (
        SpellCorrectionModelConfig()
    )  # this will instiate the model by passing required params


@dataclass
class CharacterLimiterDatasetCleanerConfig(DatasetCleanerConfig):
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.CharacterLimiterDatasetCleaner"
    character_limit: int = 300


@dataclass
class DatasetCleanerManagerConfig:
    _target_: str = "cybulldetection.data_processing.dataset_cleaners.DatasetCleanerManager"
    dataset_cleaners: dict[str, DatasetCleanerConfig] = field(default_factory=lambda: {})


# Registering all above configs into config store
